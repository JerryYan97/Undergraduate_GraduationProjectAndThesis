...
{
    public MyControlPanel ControlPanel;
    public Rigidbody HelicopterModel;
    public MyHeliRotorController MainRotorController;
    public MyHeliRotorController SubRotorController;
    ...
    //前后是Y--Y正则向前；Y负则向后。左右是X--X正则向左；X负则向右。
