Shader "Unity Shaders Book/Chapter 15/WaterWave3"
{
	Properties
	{
		...
		_FresnelOffset("FresnelOffset",Range(0.0, 1.0)) = 0.01
		...
		SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(v2f i) : SV_Target{
					...
					fixed3 bump1 = UnpackNormal(tex2D(_WaveMap, i.uv.zw + speed)).rgb;//in tangent space;
					...
					fresnel = clamp(fresnel + _FresnelOffset, 0, 1);
